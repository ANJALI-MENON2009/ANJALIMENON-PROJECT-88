...
{
       document.getElementById("blank").innerHTML= "• Key F for face • Key R for right hand • Key H for left hand • Key L for legs • Key B for body • Key N for neck • View this projct only on desktop/laptop";
